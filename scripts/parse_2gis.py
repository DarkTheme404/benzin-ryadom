...
CITY_COORDS = {
    ...
    "челябинск": (55.160026, 61.402590),
    "самара": (53.195873, 50.100193),
    "омск": (54.988480, 73.324236),
    "ростов-на-дону": (47.222078, 39.720349),
    "уфа": (54.738762, 55.972055),
    "красноярск": (56.010569, 92.852572),
    "воронеж": (51.661535, 39.200287),
    "пермь": (58.010374, 56.229434),
    "волгоград": (48.707103, 44.516338),
    # 500-900k
    "краснодар": (45.035470, 38.975313),
    "сочи": (43.585525, 39.723062),
    "тюмень": (57.152985, 65.541227),
    "ижевск": (56.852775, 53.211432),
    "барнаул": (53.346785, 83.776305),
    "иркутск": (52.286974, 104.305018),
    "ульяновск": (54.317002, 48.402885),
    "хабаровск": (48.480223, 135.071917),
    "владивосток": (43.119809, 131.886924),
    "ярославль": (57.626559, 39.893804),
    "махачкала": (42.984856, 47.504630),
    "томск": (56.501040, 84.992451),
    "оренбург": (51.767199, 55.098800),
    "кемерово": (55.354968, 86.087314),
    "новокузнецк": (53.786502, 87.155250),
    "рязань": (54.609540, 39.712570),
    "набережные челны": (55.743553, 52.411825),
    "астрахань": (46.347869, 48.033574),
    "пенза": (53.240873, 45.000542),
    "липецк": (52.610302, 39.594628),
    "тула": (54.193122, 37.617347),
    "киров": (58.603507, 49.667902),
    "чебоксары": (56.143063, 47.248821),
    "калининград": (54.710128, 20.510583),
    "брянск": (53.243400, 34.364198),
    "курск": (51.730779, 36.193561),
    "тверь": (56.859611, 35.911896),
    "иваново": (57.000633, 40.98044),
    "магнитогорск": (53.407158, 58.979413),
    "белгород": (50.595660, 36.587217),
    "архангельск": (64.539293, 40.518637),
    "владимир": (56.128156, 40.406612),
    "кострома": (57.767998, 40.926858),
    "калуга": (54.506780, 36.251720),
    "курган": (55.450126, 65.966462),
    "мурманск": (68.969562, 33.074545),
    "орел": (52.967257, 36.069647),
    "смоленск": (54.786810, 31.963915),
    ...
    "салехард": (66.530012, 66.601504),
    "сыктывкар": (61.668789, 50.836649),
    "петропавловск-камчатский": (53.024075, 158.643364),
    "южно-сахалинск": (46.959136, 142.737924),
    "якутск": (62.027221, 129.732086),
    "магадан": (59.568096, 150.808461),
    "анадырь": (64.733667, 177.510143),
    "грозный": (43.318013, 45.698290),
    "майкоп": (44.609826, 40.100655),
    "элиста": (46.308321, 44.270210),
    "абакан": (53.721152, 91.442387),
    "горно-алтайск": (51.958101, 85.973248),
    "кызыл": (51.719086, 94.437373),
    "ханты-мансийск": (61.004171, 69.001961),
}
...
async def main():
    ...
    await db.init_db()
    await db.stale_old_reports("2gis", older_than_hours=24)
    saved = 0
    prices_collected = 0
