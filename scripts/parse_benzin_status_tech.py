...
# Города-миллионники РФ (16) + крупные города + Крым/ДНР/ЛНР
DEFAULT_CITIES = [
    # Миллионники
    ...
    "Оренбург", "Пенза", "Белгород", "Курск", "Липецк", "Тула",
    "Калининград", "Мурманск", "Архангельск", "Вологда", "Псков",
    "Сыктывкар", "Петрозаводск", "Новгород", "Смоленск", "Брянск",
    "Рязань", "Тамбов", "Орёл", "Кострома", "Калуга", "Владимир",
    "Стерлитамак", "Сургут", "Нижневартовск", "Курган", "Чита",
    "Ульяновск", "Саранск", "Чебоксары", "Киров", "Грозный",
    "Махачкала", "Нальчик", "Владикавказ", "Ставрополь", "Пятигорск",
    "Майкоп", "Черкесск", "Магас",
    # Крым
    "Симферополь", "Севастополь", "Керчь", "Ялта", "Евпатория",
    "Феодосия", "Алушта", "Бахчисарай", "Саки", "Джанкой",
    # ДНР
    "Донецк", "Мариуполь", "Макеевка", "Горловка", "Краматорск",
    "Славянск", "Константиновка", "Бахмут", "Енакиево",
    # ЛНР
    "Луганск", "Алчевск", "Лисичанск", "Северодонецк", "Брянка",
    "Стаханов", "Красный Луч", "Рубежное", "Попасная",
]
