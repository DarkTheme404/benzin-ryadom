...
- **533 города с live данными** (было 117)
- **24,978 live отчётов** (было 18,105)
- **398 отчётов с лимитом/канистрами** (было 45)
- **595 отчётов с очередями** (было 0)
- **18,846 отчётов с ценами** (было 17,709)

### Источники live данных:
- fuelprice.ru: 18,833 (цены)
- azslive.ru: 5,384 (наличие, очереди)
- benzin-status.tech: 363 (цены, лимиты, канистры)
- benzinmap.ru: 352 (лимиты, канистры)
- ishubenzin.ru: 45 (наличие, цены)
